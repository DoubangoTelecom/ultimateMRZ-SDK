 ...
 * GL surface view
 */
public class MrzGLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
    private static final String TAG = MrzGLSurfaceView.class.getCanonicalName();
    ...
    public MrzGLSurfaceView(android.content.Context context) {
        super(context);
        initGL();
    }

    public MrzGLSurfaceView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        initGL();
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        final MrzUtils.MrzTransformationInfo tInfo = new MrzUtils.MrzTransformationInfo(swapSize ? imageHeight : imageWidth, swapSize ? imageWidth : imageHeight, getWidth(), getHeight());
