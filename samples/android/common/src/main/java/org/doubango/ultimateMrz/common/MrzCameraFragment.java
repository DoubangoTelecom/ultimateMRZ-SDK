...
public class MrzCameraFragment extends Fragment
    ...
    private MrzCameraFragment(final Size preferredSize, final MrzCameraFragmentSink sink) {
     ...
     * @return
     */
    public static MrzCameraFragment newInstance(final Size preferredSize, final MrzCameraFragmentSink sink) {
        return new MrzCameraFragment(preferredSize, sink);
    }
    ...
    /**
     * Opens the camera specified by {@link MrzCameraFragment#mCameraId}.
     */
