 ...
 * License activator.
 */
public class MrzLicenseActivator {

    /**
     * TAG used for the debug logs.
     */
    static final String TAG = MrzLicenseActivator.class.toString();
     ...
     */
    static final String LICENSE_TOKEN_FILE_NAME = "ultimateMRZ-token.lic";
            ...
            return Executors.newSingleThreadExecutor().submit(new Callable<String>() {
                ...
                public String call() throws Exception {
                    ...
                    try {
                        ...
                        final UltMrzSdkResult result = UltMrzSdkEngine.requestRuntimeLicenseKey(true);
                        if (!result.isOK()) {
